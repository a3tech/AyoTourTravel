...
<html>
	...
	<div class="gtco-section border-bottom">
		<div class="gtco-container">
			<div class="row">
			<h2>Laporan Data Kamar Hotel</h2>
			<div class="row">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='Tambah Kamar' onclick=window.location.href="kamar_tambah.php";>
...
<tr><td><?php echo $no;?></td>
	...
	<td><?php echo $kmr['tipe_kamar']; ?></td>
	<td align="center">
	<a href="kamar_ubah.php?id_kamar=<?php echo $kmr['id_kamar'];?>">Edit</a> | 
	<a href="aksi_hapus.php?id_kamar=<?php echo $kmr['id_kamar'];?>">Hapus</a>
	</td>
</tr></tbody>
<?php 
      $no++;
