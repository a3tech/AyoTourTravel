...
$queryEdit=mysql_query("SELECT * FROM kamar WHERE id_kamar='$idKamar'");
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<h3>Edit Data Kamar Hotel</h3>
					<form action="aksi_edit.php" method="post">
						<div class="row form-group">
							<div class="col-md-12">
							<input type="hidden" name="id_kamar" value="<?php echo $idKamar; ?>">
								<label class="sr-only" for="name">Tipe Kamar</label>
								<input type="text" id="namaKamar" name="tipe_kamar" class="form-control" placeholder="Tipe Kamar" value="<?php echo $tipeKamar;?>" >
							</div>
