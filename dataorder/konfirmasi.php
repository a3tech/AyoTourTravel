		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<h3>Konfirmasi Transaksi Paket Tour</h3>
					<form action="aksi_kirim.php" method="post">
						<div class="row form-group">
							...
							<div class="col-md-12">
								...
								<textarea id="subject" name="subject" class="form-control" placeholder="Subject"></textarea>
							</div>
							</div>
							...
							<div class="col-md-12">
								...
								<textarea id="pesan" name="pesan" cols="30" rows="10"class="form-control" placeholder="Pesan"></textarea>
							</div>
							</div>
