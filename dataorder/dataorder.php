...
<html>
	...
	<div class="gtco-section border-bottom">
		<div class="gtco-container">
			<div class="row">
			<h2>Laporan Data Transaksi Paket Tour</h2>
			<div class="row">
...
<tr>
	...
	$kueriOrder = mysql_query("select * from order_paket_tour a join paket_tour b on a.id_paket=b.id_paket");
	while($knd=mysql_fetch_array($kueriOrder)){
		?>
		<tbody>
<tr><td><?php echo $knd['id_order'];?></td>
	<td><?php echo $knd['id_paket']; ?></td>
	<td><?php echo $knd['atas_nama']; ?></td>
	<td><?php echo $knd['nama_pemesan']; ?></td>
	<td><?php echo $knd['jumlah']; ?></td>
	<td><?php echo $knd['tarif_paket']; ?></td>
	<td align="center">
	<a href="aksi_hapus.php?id_order=<?php echo $knd['id_order'];?>">Hapus</a>
	|
	<a href="laporan.php?id_order=<?php echo $knd['id_order'];?>">Detail</a>
	</td>
</tr></tbody>
<?php 
    }
