...
<html>
	...
	<nav class="gtco-nav" role="navigation">
		<div class="gtco-container">
			...
			<div class="row">
				...
				<span class="responsive"><img class="kiri" src="../images/icons/logo.png" >				</div>
	...
	<div class="gtco-section border-bottom">
		<div class="gtco-container">
			<div class="row">
			<h2>Detail Laporan Data Transaksi Paket Tour</h2>
				<div class="row">
			<div class="feature-center animate-box" data-animate-effect="fadeInLeft">

			<span class="responsive"><img class="tengah" src="../images/logo1.png" ></span></div></div>
				<div class="col-lg-12 animate-box">		



&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='Kembali' onclick=window.location.href="dataorder.php";>
<input type=button value='Konfirmasi' onclick=window.location.href="konfirmasi.php";>
...
<tr>
	...
	$kueriOrder = mysql_query("select * from order_paket_tour a join paket_tour b on a.id_paket=b.id_paket where id_order='$id_order'");
	$knd=mysql_fetch_array($kueriOrder)
		?>
		<tbody>
<tr><td><?php echo $knd['atas_nama']; ?></td>
	<td><?php echo $knd['nama_pemesan']; ?></td>
	<td><?php echo $knd['kota']; ?></td>
	<td><?php echo $knd['email']; ?></td>
	<td><?php echo $knd['nohp']; ?></td>
	<td><?php echo $knd['tanggal_berangkat']; ?></td>
	<td><?php echo $knd['jumlah']; ?></td>
	<td><?php echo $knd['tarif_paket']; ?></td>
</tr></tbody>
<?php 
    echo "</table>";
?>
