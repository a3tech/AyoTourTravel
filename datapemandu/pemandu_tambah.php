		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<h3>Tambah Data Pemandu</h3>
					<form action="aksi_simpan.php" method="post">

					<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">ID Pemandu</label>
								<input type="text" id="idPemandu" name="id_pemandu" class="form-control" placeholder="ID Pemandu">
							</div></div>

						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">Name</label>
								<input type="text" id="namaPemadu" name="nama_pemandu" class="form-control" placeholder="Nama Pemandu">
							</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="noTelp" name="no_telp" class="form-control" placeholder="No Telp">
							</div>
						</div>
