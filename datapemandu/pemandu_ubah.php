...
$queryEdit=mysql_query("SELECT * FROM pemandu WHERE id_pemandu='$idPemandu'");
$hasilQuery=mysql_fetch_array($queryEdit);
$idPemandu=$hasilQuery['id_pemandu'];
$namaPemandu=$hasilQuery['nama_pemandu'];
$noTelp=$hasilQuery['no_telp'];
				...
				<div class="col-md-12">
					...
					<form action="aksi_edit.php" method="post">
						<div class="row form-group">
							<div class="col-md-12">
							<input type="hidden" name="id_pemandu" value="<?php echo $idPemandu; ?>">
								<label class="sr-only" for="name">Name</label>
								<input type="text" id="namaPemandu" name="nama_pemandu" class="form-control" placeholder="Nama Pemandu" value="<?php echo $namaPemandu; ?>">
							</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="email">No Telp</label>
								<input type="text" id="noTelp" name="no_telp" class="form-control" placeholder="No Telp"  value="<?php echo $noTelp; ?>">
							</div>
						</div>

						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="subject">Alamat</label>
								<input type="text" id="alamat" name="alamat" class="form-control" placeholder="Alamat" value="<?php echo $alamat; ?>">
							</div>
						</div>
