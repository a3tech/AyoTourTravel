...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='Tambah Pemandu' onclick=window.location.href="pemandu_tambah.php";>
...
<tr><td><?php echo $no;?></td>
	<td><?php echo $pmd['id_pemandu']; ?></td>
	<td><?php echo $pmd['nama_pemandu']; ?></td>
	<td><?php echo $pmd['no_telp']; ?></td>
	<td><?php echo $pmd['alamat']; ?></td>
	<td align="center">
	<a href="pemandu_ubah.php?id_pemandu=<?php echo $pmd['id_pemandu'];?>">Edit</a> | 
	<a href="aksi_hapus.php?id_pemandu=<?php echo $pmd['id_pemandu'];?>">Hapus</a>
	</td>
</tr></tbody>
<?php 
      $no++;
