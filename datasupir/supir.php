...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='Tambah Supir' onclick=window.location.href="supir_tambah.php";>
...
<tr><td><?php echo $no;?></td>
	<td><?php echo $spr['id_supir']; ?></td>
	<td><?php echo $spr['nama_supir']; ?></td>
	<td><?php echo $spr['no_telp']; ?></td>
	<td><?php echo $spr['alamat']; ?></td>
	<td align="center">
	<a href="supir_ubah.php?id_supir=<?php echo $spr['id_supir'];?>">Edit</a> | 
	<a href="aksi_hapus.php?id_supir=<?php echo $spr['id_supir'];?>">Hapus</a>
	</td>
</tr></tbody>
<?php 
      $no++;
