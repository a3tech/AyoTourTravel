...
$queryEdit=mysql_query("SELECT * FROM supir WHERE id_supir='$idSupir'");
$hasilQuery=mysql_fetch_array($queryEdit);
$idSupir=$hasilQuery['id_supir'];
$namaSupir=$hasilQuery['nama_supir'];
				...
				<div class="col-md-12">
					...
					<form action="aksi_edit.php" method="post">
						<div class="row form-group">
							<div class="col-md-12">
							<input type="hidden" name="id_supir" value="<?php echo $idSupir; ?>">
								<label class="sr-only" for="name">Name</label>
								<input type="text" id="namaSupir" name="nama_supir" class="form-control" placeholder="Nama Supir" value="<?php echo $namaSupir; ?>">
							</div>
