			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">ID Supir</label>
								<input type="text" id="idSupir" name="id_supir" class="form-control" placeholder="ID Supir">
							</div></div>

						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">Name</label>
								<input type="text" id="namaSupir" name="nama_supir" class="form-control" placeholder="Nama Supir">
							</div>
