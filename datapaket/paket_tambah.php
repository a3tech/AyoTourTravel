		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<h3>Tambah Data Paket Tour</h3>
					<form action="aksi_simpan.php" method="post">
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">ID Paket</label>
								<input type="text" id="idPaket" name="id_paket" class="form-control" placeholder="ID Paket">
							</div>
						...
						<div class="row form-group">
							...
							<div class="col-md-12">
								...
								<input type="text" id="namaPaket" name="nama_paket" class="form-control" placeholder="Nama Paket">
							</div>
							...
							<div class="col-md-12">
								...
								<input type="text" id="tarifPaket" name="tarif_paket" class="form-control" placeholder="Tarif Paket">
							</div>
							</div>
							...
							<div class="col-md-12">
								...
								<input type="text" id="durasiTour" name="durasi_tour" class="form-control" placeholder="Durasi Tour">
							</div>
							</div>
							...
							<div class="col-md-12">
								...
								<textarea id="kegiatan" name="kegiatan" class="form-control" placeholder="Jadwal Kegiatan"></textarea>
							</div>
							</div>
