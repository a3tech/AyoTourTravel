...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='Tambah Paket Tour' onclick=window.location.href="paket_tambah.php";>
...
<tr>
	...
	$kueriPaket = mysql_query("select * from paket_tour");
	$no=1;
	while($pkt=mysql_fetch_array($kueriPaket)){
		?>
		<tbody>
<tr><td><?php echo $no;?></td>
	<td><?php echo $pkt['id_paket']; ?></td>
	<td><?php echo $pkt['id_kendaraan']; ?></td>
	<td><?php echo $pkt['id_hotel']; ?></td>
	<td><?php echo $pkt['kd_wilayah']; ?></td>
	<td><?php echo $pkt['nama_paket']; ?></td>
	<td><?php echo $pkt['tarif_paket']; ?></td>
	<td><?php echo $pkt['durasi_tour']; ?></td>
	<td><?php echo $pkt['favorite']; ?></td>
	<td align="center">
	<a href="paket_ubah.php?id_paket=<?php echo $pkt['id_paket'];?>">Edit</a> | 
	<a href="aksi_hapus.php?id_paket=<?php echo $pkt['id_paket'];?>">Hapus</a>
	</td>
</tr></tbody>
<?php 
      $no++;
