...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='Tambah Member' onclick=window.location.href="member_tambah.php";>
...
<tr>
	...
	$kueriMember = mysql_query("select * from member");
	$no=1;
	while($mbr=mysql_fetch_array($kueriMember)){
		?>
		<tbody>
<tr><td><?php echo $no;?></td>
	...
	<td><?php echo $mbr['password']; ?></td>
	<td align="center">
	<a href="member_ubah.php?id_member=<?php echo $mbr['id_member'];?>">Edit</a> | 
	<a href="aksi_hapus.php?id_member=<?php echo $mbr['id_member'];?>">Hapus</a>
	</td>
</tr></tbody>
<?php 
      $no++;
