...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='Tambah Kendaraan' onclick=window.location.href="kendaraan_tambah.php";>
...
<tr><td><?php echo $no;?></td>
	<td><?php echo $knd['id_kendaraan']; ?></td>
	<td><?php echo $knd['id_supir']; ?></td>
	<td><?php echo $knd['id_pemandu']; ?></td>
	<td><?php echo $knd['nopol']; ?></td>
	<td><?php echo $knd['jenis_kendaraan']; ?></td>
	<td><?php echo $knd['perusahaan']; ?></td>
	<td align="center">
	<a href="kendaraan_ubah.php?id_kendaraan=<?php echo $knd['id_kendaraan'];?>">Edit</a> | 
	<a href="aksi_hapus.php?id_kendaraan=<?php echo $knd['id_kendaraan'];?>">Hapus</a>
	</td>
</tr></tbody>
<?php 
      $no++;
