				...
				<div class="col-md-12">
					...
					<form action="aksi_simpan.php" method="post">
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">ID Kendaraan</label>
								<input type="text" id="idKendaraan" name="id_kendaraan" class="form-control" placeholder="ID Kendaraan">
							</div>
						...
						<div class="row form-group">
							...
							<div class="col-md-12">
								...
								<input type="text" id="nopol" name="nopol" class="form-control" placeholder="Nopol">
							</div>
							...
							<div class="col-md-12">
								...
								<input type="text" id="jenisKendaraan" name="jenis_kendaraan" class="form-control" placeholder="Jenis Kendaraan">
							</div>
