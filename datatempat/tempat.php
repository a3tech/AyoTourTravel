...
<html>
	...
	<div class="gtco-section border-bottom">
		<div class="gtco-container">
			<div class="row">
			<h2>Laporan Data Destinasi Tempat Wisata</h2>
			<div class="row">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='Tambah Tempat Wisata' onclick=window.location.href="tempat_tambah.php";>
...
<tr>
	...
	$kueriTempat = mysql_query("select * from tempat_wisata");
	$no=1;
	while($tpt=mysql_fetch_array($kueriTempat)){
		?>
		<tbody>
<tr><td><?php echo $no;?></td>
	<td><?php echo $tpt['kd_wilayah']; ?></td>
	<td><?php echo $tpt['lokasi_wisata']; ?></td>
	<td><?php echo $tpt['kategori']; ?></td>
	<td><?php echo $tpt['foto_tempat']; ?></td>
	<td><?php echo $tpt['fotoo']; ?></td>
	<td><?php echo $tpt['fotooo']; ?></td>
	<td align="center">
	<a href="tempat_ubah.php?kd_wilayah=<?php echo $tpt['kd_wilayah'];?>">Edit</a> | 
	<a href="aksi_hapus.php?kd_wilayah=<?php echo $tpt['kd_wilayah'];?>">Hapus</a>
	</td>
</tr></tbody>
<?php 
      $no++;
