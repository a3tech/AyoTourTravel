			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">Kode Wilayah</label>
								<input type="text" id="kdWilayah" name="kd_wilayah" class="form-control" placeholder="Kode Wilayah">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="lokasiWisata" name="lokasi_wisata" class="form-control" placeholder="Lokasi Wisata">
							</div>
						</div>
						...
						<div class="row form-group">
							...
							<div class="col-md-12">
								...
								<input type="file" id="gambar" name="gambar[]" multiple class="form-control" placeholder="Foto Tempat 1">
							</div>
						</div>
