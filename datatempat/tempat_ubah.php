...
$queryEdit=mysql_query("SELECT * FROM tempat_wisata WHERE kd_wilayah='$kd_wilayah'");
$hasilQuery=mysql_fetch_array($queryEdit);
$kd_wilayah=$hasilQuery['kd_wilayah'];
$lokasi_wisata = $hasilQuery['lokasi_wisata'];
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row form-group">
							<div class="col-md-12">
							<input type="hidden" name="kd_wilayah" value="<?php echo $kd_wilayah; ?>">
								<label class="sr-only" for="email">Lokasi Wisata</label>
								<input type="text" id="lokasiWisata" name="lokasi_wisata" class="form-control" placeholder="Lokasi Wisata" value="<?php echo $lokasi_wisata; ?>">
							</div>
						</div>

					<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="subject">Kategori</label>
								<input type="text" id="kategori" name="kategori" class="form-control" placeholder="Kategori" value="<?php echo $kategori; ?>">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="file" id="gambar" name="gambar[]" multiple class="form-control" placeholder="Foto Tempat">
							</div>
						</div>
