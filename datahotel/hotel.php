...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='Tambah Hotel' onclick=window.location.href="hotel_tambah.php";>
...
<tr><td><?php echo $no;?></td>
	<td><?php echo $htl['id_hotel']; ?></td>
	<td><?php echo $htl['id_kamar']; ?></td>
	<td><?php echo $htl['nama_hotel']; ?></td>
	<td><?php echo $htl['alamat']; ?></td>
	<td align="center">
	<a href="hotel_ubah.php?id_hotel=<?php echo $htl['id_hotel'];?>">Edit</a> | 
	<a href="aksi_hapus.php?id_hotel=<?php echo $htl['id_hotel'];?>">Hapus</a>
	</td>
</tr></tbody>
<?php 
      $no++;
