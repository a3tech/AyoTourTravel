...
$queryEdit=mysql_query("SELECT * FROM hotel WHERE id_hotel='$idHotel'");
$hasilQuery=mysql_fetch_array($queryEdit);
$idHotel=$hasilQuery['id_hotel'];
$idKamar=$hasilQuery['id_kamar'];
					...
					<form action="aksi_edit.php" method="post">
						...
						<div class="row form-group">
							<div class="col-md-12">		
								...
								<input type="text" id="namaHotel" name="nama_hotel" class="form-control" value="<?php echo $namaHotel;?>" >
							</div>
