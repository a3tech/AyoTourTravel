				...
				<div class="col-md-12">
					...
					<form action="aksi_simpan.php" method="post">
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">ID Hotel</label>
								<input type="text" id="idHotel" name="id_hotel" class="form-control" placeholder="ID Hotel">
							</div>
						...
						<div class="row form-group">
							...
							$kueriKamar = mysql_query("select * from kamar");
							while ($kmr=mysql_fetch_array($kueriKamar))
							{?>
							<option value="<?php echo $kmr['id_kamar']; ?>"><?php echo $kmr['tipe_kamar'];?></option>
							<?php } ?></select>
							</div>
						</div>
							...
							<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">Nama Hotel</label>
								<input type="text" id="namaHotel" name="nama_hotel" class="form-control" placeholder="Nama Hotel">
							</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">Alamat</label>
