...
<html>
	...
	<div class="gtco-section border-bottom">
		<div class="gtco-container">
			<div class="row">
			<h2>Laporan Data  Testimoni Pelanggan</h2>
			<div class="row">
...
<tr>
	...
	$kueriKendaraan = mysql_query("select * from testimonial");
	$no=1;
	while($knd=mysql_fetch_array($kueriKendaraan)){
		?>
		<tbody>
<tr><td><?php echo $no;?></td>
	<td><?php echo $knd['nama']; ?></td>
	<td><?php echo $knd['email']; ?></td>
	<td><?php echo $knd['pesan']; ?></td>
	<td><?php echo $knd['tanggal']; ?></td>
	<td align="center">
	<a href="testimonial_ubah.php?id_testimoni=<?php echo $knd['id_testimoni'];?>">Edit</a> | 
	<a href="aksi_hapus.php?id_testimoni=<?php echo $knd['id_testimoni'];?>">Hapus</a>
	</td>
</tr></tbody>
<?php 
      $no++;
