					...
					<form action="aksi_simpan.php" method="post" enctype="multipart/form-data">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea type="text" id="pesan" name="pesan" class="form-control" placeholder="Testimoni"></textarea>
							</div>
						</div>
							...
							<div class="col-md-12">
								...
								<input type="file" id="gambar" name="gambar" class="form-control" placeholder="Foto Tempat">
							</div>
						</div>
