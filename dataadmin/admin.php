...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='Tambah Admin' onclick=window.location.href="admin_tambah.php";>
...
<tr>
	...
	$kueriAdmin = mysql_query("select * from admin");
	$no=1;
	while($adm=mysql_fetch_array($kueriAdmin)){
		?>
		<tbody>
<tr><td><?php echo $no;?></td>
	...
	<td align="center">
	<a href="admin_ubah.php?id_admin=<?php echo $adm['id_admin'];?>">Edit</a> | 
	<a href="aksi_hapus.php?id_admin=<?php echo $adm['id_admin'];?>">Hapus</a>
	</td>
</tr></tbody>
<?php 
      $no++;
