			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">ID Admin</label>
								<input type="text" id="idAdmin" name="id_admin" class="form-control" placeholder="ID Admin">
							</div></div>

						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">Name</label>
								<input type="text" id="namaAdmin" name="nama_admin" class="form-control" placeholder="Nama Admin">
							</div>
