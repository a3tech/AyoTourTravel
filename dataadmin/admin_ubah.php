...
$queryEdit=mysql_query("SELECT * FROM admin WHERE id_admin='$idAdmin'");
					...
					<form action="aksi_edit.php" method="post">
						<div class="row form-group">
							...
							<input type="hidden" name="id_admin" value="<?php echo $idAdmin; ?>">
								...
								<input type="text" id="namaAdmin" name="nama_admin" class="form-control" placeholder="Nama Admin" value="<?php echo $namaAdmin; ?>">
							</div>
